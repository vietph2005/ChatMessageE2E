...
public class UserRepositoryImpl implements UserRepository {
    ...
    private UserDocument toDocument(UserProfile user) {
        return UserDocument.builder()
                ...
                .blockedUserIds(user.getBlockedUserIds() != null ? user.getBlockedUserIds() : new java.util.HashSet<>())
    ...
    private UserProfile toDomain(UserDocument doc) {
        return UserProfile.builder()
                ...
                .blockedUserIds(doc.getBlockedUserIds() != null ? doc.getBlockedUserIds() : new java.util.HashSet<>())
